...
int i, user_id;
char ch;
FILE *user = NULL, *store = NULL, *item = NULL, *tmp_file = NULL;
bool exitProgram = false, found = false; // Flag to indicate if the ID was found
...
void search_users()
{
  ...
  // Return to the calling function (manage_users) when goBack is set
  return;
}
